...
`,$t={sensor:"sensors",binary_sensor:"binary_sensors",button:"buttons",switch:"switches",number:"numbers",select:"selects"};function wt(t){const e=t.indexOf(".");if(e<0)return;const i=t.substring(e+1);for(const t of bt)if(i.endsWith(t)){const e=i.substring(0,i.length-t.length);if(""===e||e.endsWith("_"))return t}}function xt(t,e){if(t.entities)for(const[i,s]of Object.entries(t.entities))if(s.device_id===e)return i}function At(t,e){if(!e)return;const i=t.states[e]?.state;return"unavailable"!==i&&"unknown"!==i?i:void 0}function Et(t,e){const i=At(t,e);if(void 0===i)return;const s=Number(i);return isNaN(s)?void 0:s}function St(t,e){if(!e)return!1;const i=t.states[e]?.state;return"on"===i||"connected"===i||"true"===i||"True"===i}function Ct(t,e){const i=At(t,e);if(i)try{const t=new Date(i);return isNaN(t.getTime())?i:t.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}catch{return i}}console.info("%c PETLIBRO-CARD %c v0.2.5 ","color: white; background: #3498db; font-weight: bold;","color: #3498db; background: white; font-weight: bold;"),window.customCards=window.customCards||[],window.customCards.push({type:vt,name:"Petlibro Card",description:"Auto-detecting card for PetLibro feeders, fountains, and litter boxes",preview:!0});let kt=class extends at{static{this.styles=yt}static async getConfigElement(){return await Promise.resolve().then(function(){return Ot}),document.createElement(pt)}static getStubConfig(){return{device_id:""}}setConfig(t){if(!t.device_id&&!t.entity)throw new Error("Please select a PetLibro device");this._config={show_controls:!0,...t}}getCardSize(){return 4}shouldUpdate(t){if(t.has("_config"))return!0;if(!t.has("hass")||!this._entities)return!0;const e=t.get("hass");if(!e)return!0;return this._getAllEntityIds().some(t=>e.states[t]!==this.hass.states[t])}willUpdate(t){var e,i;if(this.hass&&this._config&&(t.has("hass")||t.has("_config"))){let t;this._config.device_id?t=this._config.device_id:this._config.entity&&(e=this.hass,i=this._config.entity,t=e.entities?.[i]?.device_id??void 0),t&&t!==this._deviceId&&(this._deviceId=t,this._entities=function(t,e){const i={sensors:{},binary_sensors:{},buttons:{},switches:{},numbers:{},selects:{}};if(!t.entities)return i;for(const[s,o]of Object.entries(t.entities)){if(o.device_id!==e)continue;const t=s.substring(0,s.indexOf(".")),n=$t[t];if(!n)continue;const r=wt(s);r&&(i[n][r]=s)}return i}(this.hass,t),this._deviceType=function(t){const e=new Set([...Object.keys(t.sensors),...Object.keys(t.binary_sensors),...Object.keys(t.buttons),...Object.keys(t.switches)]);return ft.some(t=>e.has(t))?"litter_box":mt.some(t=>e.has(t))?"feeder":gt.some(t=>e.has(t))?"fountain":"feeder"}(this._entities))}}render(){if(!this._config||!this.hass)return B``;if(!this._deviceId||!this._entities||!this._deviceType)return B`
    ...
    `}_renderDeviceContent(){if(!this._entities)return F;switch(this._deviceType){case"feeder":return function(t,e,i){const s=Et(t,e.sensors.electric_quantity),o=St(t,e.binary_sensors.food_low),n=At(t,e.sensors.today_feeding_quantity_weight),r=At(t,e.sensors.today_feeding_times),a=Ct(t,e.sensors.last_feed_time),c=Ct(t,e.sensors.next_feed_time),d=At(t,e.sensors.next_feed_quantity_weight),l=At(t,e.sensors.feeding_plan_state),h=t.states[e.sensors.today_feeding_quantity_weight??""]?.attributes?.unit_of_measurement??"g",u=t.states[e.sensors.next_feed_quantity_weight??""]?.attributes?.unit_of_measurement??"g",_=St(t,e.binary_sensors.light_switch);return B`
